...
begin
  ...
  try
    ...
    begin
      ...
      TIPOEMPRESA_WEB := (JSONObj.GetValue<string>('opcao_pelo_simples', 'Não disponível'));
      ...
      try
        ...
        Memo1.Lines.Add('');
        Memo1.Lines.Add('Informações Empresa:');
        Memo1.Lines.Add('');
        ...
        Memo1.Lines.Add('');
        Memo1.Lines.Add(' CEP: ' + JSONObj.GetValue<string>('cep', 'Não disponível'));
        Memo1.Lines.Add('');
